...
export namespace BatchHttpLink {
  ...
  export type DefaultOptions = Required<
    Pick<BatchHttpLink.Options, "uri" | "print" | "includeUnusedVariables">
  >;
}
...
export class BatchHttpLink extends ApolloLink {
  ...
  protected fetchParams: BatchHttpLink.DefaultOptions & BatchHttpLink.Options;
  ...
  public batchHandler(operations: Operation[]) {
    const {
      uri,
      fetch: fetcher,
      print,
  ...
  public batchKey(operation: Operation): string {
    const { uri } = this.fetchParams;
